...
執行上面兩個指令後，就可以[在視窗操作下面兩個動作](https://samwhelp.github.io/note-about-anduinos-gnome-shell/read/config/mousebind.html#視窗內容區塊)，
...
| 相關議題 |
| ------- |
| [滑鼠按鍵綁定](https://samwhelp.github.io/note-about-anduinos-gnome-shell/read/config/mousebind.html#視窗內容區塊) |
