...
* [gnome-shell-keybind-custom](https://github.com/samwhelp/note-about-anduinos/blob/gh-pages/_demo/adjustment/de/gnome-shell/part/gnome-shell-keybind-custom/config-install.sh)
